...
static KeymapEntry keymap[] = {
	...
	{ 2, 0, MOD_SHFT, true  }, // 0x21 !
	{ 2, 1, MOD_SHFT, true  }, // 0x22 "
	{ 6, 5, MOD_NONE, true  }, // 0x23 #
	{ 3, 1, MOD_SHFT, true  }, // 0x24 $
	{ 4, 0, MOD_SHFT, true  }, // 0x25 %
	{ 4, 1, MOD_SHFT, true  }, // 0x26 &
	{ 6, 5, MOD_SHFT, true  }, // 0x27 '
	{ 5, 1, MOD_SHFT, true  }, // 0x28 (
	{ 6, 0, MOD_SHFT, true  }, // 0x29 )
	{ 7, 3, MOD_SHFT, true  }, // 0x2A *
	{ 7, 3, MOD_NONE, true  }, // 0x2B +
	{ 4, 7, MOD_NONE, true  }, // 0x2C ,
	{ 5, 7, MOD_NONE, true  }, // 0x2D -
	{ 5, 6, MOD_NONE, true  }, // 0x2E .
	{ 5, 0, MOD_SHFT, true  }, // 0x2F /
	...
	{ 5, 6, MOD_SHFT, true  }, // 0x3A :
	{ 4, 7, MOD_SHFT, true  }, // 0x3B ;
	{ 9, 9, MOD_NONE, false }, // 0x3C <
	{ 6, 1, MOD_SHFT, true  }, // 0x3D =
	{ 9, 9, MOD_CODE, true  }, // 0x3E >
	{ 6, 6, MOD_SHFT, true  }, // 0x3F ?
	{ 9, 9, MOD_NONE, false }, // 0x40 @
	{ 1, 4, MOD_SHFT, true  }, // 0x41 A
	{ 3, 6, MOD_SHFT, true  }, // 0x42 B
	{ 2, 6, MOD_SHFT, true  }, // 0x43 C
	{ 2, 4, MOD_SHFT, true  }, // 0x44 D
	{ 2, 2, MOD_SHFT, true  }, // 0x45 E
	{ 2, 5, MOD_SHFT, true  }, // 0x46 F
	{ 3, 4, MOD_SHFT, true  }, // 0x47 G
	{ 3, 5, MOD_SHFT, true  }, // 0x48 H
	{ 5, 3, MOD_SHFT, true  }, // 0x49 I
	{ 4, 4, MOD_SHFT, true  }, // 0x4A J
	{ 4, 5, MOD_SHFT, true  }, // 0x4B K
	{ 5, 4, MOD_SHFT, true  }, // 0x4C L
	{ 4, 6, MOD_SHFT, true  }, // 0x4D M
	{ 3, 7, MOD_SHFT, true  }, // 0x4E N
	{ 5, 2, MOD_SHFT, true  }, // 0x4F O
	{ 6, 3, MOD_SHFT, true  }, // 0x50 P
	{ 1, 2, MOD_SHFT, true  }, // 0x51 Q
	{ 3, 3, MOD_SHFT, true  }, // 0x52 R
	{ 1, 5, MOD_SHFT, true  }, // 0x53 S
	{ 3, 2, MOD_SHFT, true  }, // 0x54 T
	{ 4, 2, MOD_SHFT, true  }, // 0x55 U
	{ 2, 7, MOD_SHFT, true  }, // 0x56 V
	{ 2, 3, MOD_SHFT, true  }, // 0x57 W
	{ 1, 7, MOD_SHFT, true  }, // 0x58 X
	{ 1, 6, MOD_SHFT, true  }, // 0x59 Y
	{ 4, 3, MOD_SHFT, true  }, // 0x5A Z
	{ 9, 9, MOD_NONE, false }, // 0x5B [
	{ 9, 9, MOD_NONE, false }, // 0x5C /* \ */
	{ 9, 9, MOD_NONE, false }, // 0x5D ]
	{ 9, 9, MOD_NONE, false }, // 0x5E ^
	{ 5, 7, MOD_SHFT, true  }, // 0x5F _
	{ 7, 1, MOD_SHFT, true  }, // 0x60 `
	...
	{ 6, 4, MOD_SHFT, true  }, // 0xA0 Ä
	{ 5, 5, MOD_NONE, true  }, // 0xA1 ö
	{ 5, 5, MOD_SHFT, true  }, // 0xA2 Ö
	{ 6, 2, MOD_NONE, true  }, // 0xA3 ü
	{ 6, 2, MOD_SHFT, true  }, // 0xA4 Ü
	{ 6, 6, MOD_NONE, true  }, // 0xA5 ß

	{ 5, 0, MOD_CODE, true  }, // 0xA6 AUTORETURN ON
	{ 5, 1, MOD_CODE, true  }, // 0xA7 AUTORETURN OFF
	{ 6, 0, MOD_CODE, true  }, // 0xA8 DOWN
	{ 6, 1, MOD_CODE, true  }, // 0xA9 UP
	{ 3, 1, MOD_CODE, true  }, // 0xAA UNDERLINE ON
	{ 4, 0, MOD_CODE, true  }, // 0xAB UNDERLINE OFF
	{ 2, 1, MOD_CODE, true  }, // 0xAC CTR
	{ 3, 0, MOD_CODE, true  }, // 0xAD RMF
};
